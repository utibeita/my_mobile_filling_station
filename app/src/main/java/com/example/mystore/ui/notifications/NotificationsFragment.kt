...
import com.example.mystore.databinding.FragmentNotificationsBinding
...
class NotificationsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.listOfNotification.adapter = NotificationsAdapter(requireContext(),
            listOfNotifications, notificationsViewModel)
